...
export const HomeHeader = () => {
    ...
    return (
        <div className="bg-gradient-to-r from-white from-40% to-[#e6e7d2]">
            <div className="flex justify-between items-center py-16 w-full px-8 bg-hero-pattern bg-contain bg-center">
